...
g++ CrossSectionRatio2.C $(root-config --cflags --libs) -g -o CrossSectionRatio2.exe 
./CrossSectionRatio2.exe "$FONLLOUTPUTFILE"  "$OUTPUTFILEPP" "$OUTPUTFILEMCSTUDYPP" "$OUTPUTFILEPlotPP" 0 "$LABELPP" 0 "$LUMIPP"
rm CrossSectionRatio2.exe
fi
