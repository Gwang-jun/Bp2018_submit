...
//=========  (Fri Jul 26 17:13:26 2019) by ROOT version 6.12/07
   ...
   hEff__2->SetBinContent(1,0.01052299);
   hEff__2->SetBinContent(2,0.01017162);
   hEff__2->SetBinContent(3,0.01130693);
   hEff__2->SetBinContent(4,0.01659278);
   hEff__2->SetBinError(1,0.0002449529);
   hEff__2->SetBinError(2,0.0002431963);
   hEff__2->SetBinError(3,0.000332059);
   hEff__2->SetBinError(4,0.0004030946);
   hEff__2->SetEntries(6025.616);
   hEff__2->SetStats(0);
